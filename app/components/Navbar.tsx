    ...
    return (
        <nav className="sticky top-0 z-50">
            ...
            <AnimatePresence>
                {showBanner && (
                    <motion.div
                        ...
                        className="bg-gradient-to-r from-purple-400/50 to-purple-400/40 text-white py-2.5 px-4"
                    >
            ...
            <motion.div
                ...
                className="container mx-auto px-4 lg:px-8 pt-4"
            >
                                                ...
                                                >
                                                    <div className="flex items-center">
                                                        <div className="w-8 h-8 mr-2  rounded-lg flex items-center text-gray-300 justify-center">
                                                            <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" strokeLinecap="round" stroke-linejoin="round" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg"><rect width="7" height="18" x="3" y="3" rx="1"></rect><rect width="7" height="7" x="14" y="3" rx="1"></rect><rect width="7" height="7" x="14" y="14" rx="1"></rect></svg>
                                                        </div>
                                                        <div>
