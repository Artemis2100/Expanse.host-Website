...
export default function PanelShowcase({
    ...
    subtitle = "Experience seamless server management with our cutting-edge control panel",
    panelName = "Tenantos",
    panelDescription = "Tenantos is a modern, intuitive control panel designed for dedicated server management. With its user-friendly interface and powerful features, you can manage your infrastructure effortlessly.",
    features = [
        {
